...
var TestApi = (function () {
    ...
    TestApi.getComment = function (id) {
        var topList = this.topList;
        for (var i = 0; i < topList.length; i++) {
            for (var j = 0; j < topList[i].cmtList.length; j++) {
